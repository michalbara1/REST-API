...
describe("Auth Tests", () => {
    ...
    test('Login when invalid credentials are provided', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app)
            .post('/auth/login')
            .send({ email: 'wronguser@test.com', password: 'wrongpassword' });
        expect(response.status).toBe(400);
        expect(response.text).toBe('wrong username or password');
    }));
    test('Refresh token is invalid during logout', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app)
            .post('/auth/logout')
    ...
    test("should return 401 if token is invalid", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test("should return 400 when refresh token is missing", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app).post(baseUrl + "/refresh").send({});
        expect(response.statusCode).toBe(400);
        expect(response.text).toBe("fail");
    }));
    test("should return 400 when refresh token is invalid", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app).post(baseUrl + "/refresh").send({ refreshToken: "invalidToken" });
        expect(response.statusCode).toBe(400);
        expect(response.text).toBe("fail");
    }));
});
